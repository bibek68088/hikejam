...
const UserDashboard = () => {
  ...
  return (
    <div className="flex h-screen font-sans bg-gray-50">
      <aside className="w-64 bg-white text-gray-800 p-5 flex flex-col shadow-lg md:w-64 md:order-1 order-2">
      ...
      <main className="flex-grow p-8 bg-gray-50 overflow-y-auto md:order-2 order-1">
