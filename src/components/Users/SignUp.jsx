...
const Signup = () => {
  ...
  const handleSignup = (e) => {
    ...
    // Validate all fields
    const validationResults = Object.keys(formData).map((key) => validate(key, formData[key]))
      ...
      <div className="auth-card">
        ...
        <div className="auth-form">
          ...
          <p className="auth-subtitle">
            Our platform is designed for hiking enthusiasts to explore breathtaking trials, share experiences, and
            connect with fellow adventures.
          </p>
